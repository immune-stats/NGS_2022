...
# ridge_fit <- glmnet(x = ___, y = ___, alpha = ___, standardize = TRUE, family = "gaussian")
...
# cv_ridge_fit <- cv.glmnet(x = ___, y = ___, alpha = ___, standardize = TRUE, family = "gaussian", type.measure = "mse", nfold = 10)
...
# cv_ridge_coef <- coef(___, s = ___)


# fitted values
# cv_ridge_pred <- predict(object = ___, s = ___, newx = x)
```
...
# cv_fit_elastic_net_coef <- ___


# fitted values
# cv_fit_elastic_net_pred <- ___
```
